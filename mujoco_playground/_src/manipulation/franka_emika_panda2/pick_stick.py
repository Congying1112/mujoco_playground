...
from mujoco_playground._src.manipulation.franka_emika_panda2 import panda
...
class PandaPickStick(panda.PandaBase):
  """Bring a stick to a target."""
...
class PandaPickStickOrientation(PandaPickStick):
  """Bring a stick to a target and orientation."""
