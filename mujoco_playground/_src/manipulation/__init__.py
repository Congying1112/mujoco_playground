...
from mujoco_playground._src.manipulation.franka_emika_panda2 import pick_stick as panda_pick_stick
...
_envs = {
    ...
    "PandaPickStick": panda_pick_stick.PandaPickStick,
    "PandaPickStickOrientation": panda_pick_stick.PandaPickStickOrientation,
...
_cfgs = {
    ...
    "PandaPickStick": panda_pick_stick.default_config,
    "PandaPickStickOrientation": panda_pick_stick.default_config,
